...
const AuthPage: React.FC<AuthPageProps> = ({ onLogin, users, siteName, siteLogo }) => {
    ...
    <div className="min-h-screen bg-slate-900 flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          <div className="w-20 h-20 bg-blue-600 rounded-3xl mx-auto flex items-center justify-center font-black text-white text-4xl shadow-2xl shadow-blue-500/50 mb-6 overflow-hidden">
            {siteLogo ? (
          ...
          <h1 className="text-3xl font-black text-white tracking-tight uppercase">{siteName}</h1>
